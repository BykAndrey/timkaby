...
<div id="PROP">
<form id="good_property_category_create" method="post" action="<?php echo e(route('admin::good_property_category_create')); ?>">
    <?php echo e(csrf_field()); ?>

    <input type="hidden" name="id_good_category" value="<?php echo e($model->id); ?>">
...
<script>
    var prop=new Vue({
        ...
        data:{
            name:'',
            id_category:<?php echo e($model->id); ?>,
            listProp:[],
        ...
        methods:{
            addProp:function (event) {
                ...
                if(this.name.length>=3){
                    ...
                    $.ajax({
                        url:'<?php echo e(route('admin::good_property_category_create')); ?>',
                        method:'post',
                        async:false,
                        data:{
                            'name':prop.name,
