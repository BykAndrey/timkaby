<?php $__env->startSection('content'); ?>
    ...
    <div id="tabs">
        ...
        <div id="offer">
            <h3> Предложения </h3>
            <a href="<?php echo e(route('admin::good_item_create',['id_good_item_group'=>$model->id])); ?>">Добавить предложение</a>
          <div id="list_offer" >
        ...
        <script>
            ...
            var id_item_group=<?php echo e($model->id); ?>;
            var imagesG=new Vue({
                el:'#images',
                data:{
                    images:{},
            ...
            function refresh() {
                $.ajax({
                    url:'<?php echo e(route('admin::good_item_group_listItem',['id'=>$model->id])); ?>',
                    method:'get',
                    dataType:'json',
