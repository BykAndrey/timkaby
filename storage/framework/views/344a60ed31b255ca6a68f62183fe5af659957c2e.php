<?php $__env->startSection('header'); ?>
    <title><?php echo e($Cat->title); ?> -Timka.by </title>
    <meta name="description" content="<?php echo e($Cat->meta_description); ?>"/>
...
<?php $__env->startSection('tree'); ?>
    <?php if(isset($subcat)): ?>
    <div class="tree">
        <h2 class="head"><?php echo e($Cat->name); ?></h2>
        <ul class="no-padding">
        <?php foreach($subcat as $cat): ?>
            <li>
                <i><a href="<?php echo e(route('home::catalog',['url'=>$cat->url])); ?>"><?php echo e($cat->name); ?></a></i></li>
            <?php endforeach; ?>
        </ul>
    </div>
    <?php endif; ?>
...
<?php $__env->startSection('data'); ?>
    ...
    <div itemscope itemtype="http://schema.org/Product" class="block_good" id="catalog">
        ...
        <div class="head">
            <h2 itemprop="name"><?php echo e($Cat->name); ?></h2>
        ...
        <div class ="sub_categories">
            <?php foreach($subcat as $item): ?>
                <div><img src="/<?php echo e(\App\ItemGroup::getImage($item->image,100,null)); ?>" alt="<?php echo e($item->name); ?>" width="50">
                        <p>
        ...
        'route'=>'home::catalog',
        'routeParams'=>[
        'url'=>$Cat->url]], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<?php $__env->startSection('scripts'); ?>
      ...
      <!--  <script src="<?php echo e(URL::asset('static/js/compvue/good.js')); ?>"></script>-->
    ...
    /*****************************************************/
            ...
            MinPrice=params.hasOwnProperty('min_price')?params['min_price']:<?php echo e($min_price); ?>;
           // MaxPrice=params.hasOwnProperty('rangePrice[]')?params['rangePrice[]'][1]:null
            MaxPrice=params.hasOwnProperty('max_price')?params['max_price']:<?php echo e($max_price); ?>;
           ...
           // console.log([params['filterSelectID[]']]);
            ...
            function getlist() {
                ...
                $.ajax({
                    url:'/catalog/<?php echo e($Cat->url); ?>',
                    async:false,
                    data:{
                        //'action':'getListItemGroup_Catalog',
                        //'url':'<?php echo e($Cat->url); ?>',
                        'page':page,
                        'size':size,
