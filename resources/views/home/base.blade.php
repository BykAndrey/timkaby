...
<head>
    ...
    <link rel="stylesheet" href="{{URL::asset('static/css/mainstyle.css')}}">
    <link rel="stylesheet" href="{{URL::asset('static/css/media.css')}}">
  ...
  <!--<script src="//ajax.googleapis.com/ajax/libs/jqueryui/1.9.1/jquery-ui.min.js"></script>-->
    ...
    <script src="{{URL::asset('static/js/plugin/vue.min.js')}}"></script>
...
<header>
            ...
            <div class="menu">
                ...
                @if($user!=false)
                        ...
                        <p>
                            ...
                            <img src="{{URL::asset('static/img/user.svg')}}" alt="{{$user}}" width="18">
                        ...
                        <p>
                            ...
                            <a href="{{route('user::like-good')}}">
                                <img src="{{URL::asset('static/img/heart.svg')}}" alt="Избранное" width="18">
                                <span>
                                    Избранное
                                </span>
                            </a>
                        ...
                        <p>
                            <a href="{{route('user::logout')}}"><img src="{{URL::asset('static/img/key.svg')}}" alt="Выход" width="18">
                                <span>
                                    Выход
                                </span>
                            </a>
    ...
    <div class="logo-search-cart container">
        ...
        <div class="header_cart" id='header_cart'>
            <a href="{{route('cart::home')}}"><div class="tocart">

            </div></a>
            <div class="info" style="display: none;">
                <p>
                    <a href="{{route('cart::home')}}">Корзина</a>
                </p>
                <span>
    ...
    <div class="navigation">
        <nav class="container">
            <ul>
                ...
                @foreach($base_menu as $i)
                    <li><a href="{{route('infopage',['url'=>$i['url']])}}">{{$i['name']}}</a></li>
                    @endforeach
                <li><a href="/news">Новости</a></li>

                <li><a href="{{route('home::base_catalog',['is_new'=>1])}}">Новинки!</a></li>
            </ul>
        </nav>
    </div>
</header>
...
<div class="display photo">
    ...
    <div class="window">
        ...
        <div class="controls">
            <div class="exit">
                <img src="{{URL::asset('static/img/cross.svg')}}" alt="Закрыть" width="25">
            </div>
            <div class="left"><img src="{{URL::asset('static/img/left-black.svg')}}" alt="Влево" width="35"></div>
            <div class="right"><img src="{{URL::asset('static/img/right-black.svg')}}" alt="Вправо" width="35"></div>
        </div>
    </div>
</div>
<!--END DISPLAY-->
...
<div class="content container">
    ...
    <div class="aside_toggle">
        <img src="{{URL::asset('static/img/arrow_down.svg')}}" alt="Развернуть панель" width="15">
    </div>
    <aside id='aside'>
        <div class="cat_menu">
        <div class="toggle">
            <img src="{{URL::asset('static/img/menu.svg')}}" alt="Открыть меню" width="25">
            <h2>Категории</h2><img src="{{URL::asset('static/img/arrow_down.svg')}}" alt="Открыть меню" width="15">
        </div>
        <ul class="list"> <!-- <img src="images/iconmonstr-arrow-25.svg" width="15" alt="">-->

            @foreach($good_category as $item)
                <li>
                    <div>
                        <a href="{{route('home::catalog',['url'=>$item->url])}}">{{$item->name}}</a>
                        @if(count($item->subcat)>0)
                            <img src="{{URL::asset('static/img/iconmonstr-arrow-25.svg')}}" width="15" alt="Раскрыть">
                        @endif
                    </div>
                    @if(count($item->subcat)>0)
                    ...
                    <div>
                        <ul>
                            @foreach($item->subcat as $sub)
                                <li><a href="{{route('home::catalog',['url'=>$sub->url])}}">
                                        <img src="/{{\App\ItemGroup::getImage($sub->image,100,null)}}" alt="{{$sub->name}}" width="100">
                                        <span>{{$sub->name}}</span>
                                    </a>
                                </li>
                            @endforeach
    ...
    <!-- VK Widget -->
        ...
        <!--NESW WIDGET-->
        @include('home.parts.elements.newsWidget')

    <div  class="side_cycles">

        <div id="move_to_top" class="block color-red">
            <div class="cycle">
                <img src="{{URL::asset('/static/img/top_white.svg')}}" alt="ВВЕРХ!" width="35">
            </div>
            <div class="message" >
...
<footer>
    <div class="container container_content-space-between top">
        ...
        <div class="perc-30" itemscope itemtype="http://schema.org/Organization">
            ...
            <ul>
                <li class="center">
                    <img src="{{URL::asset('static/img/MTS.svg')}}"  height="20" alt="MTS">
                    <span itemprop="telephone">
                        +375 (29) 565-56-68
                    </span>
                </li>
                <li class="center">
                    <img src="{{URL::asset('static/img/velcome2.svg')}}"  height="20" alt="Velcom">
                    <span itemprop="telephone">
                        +375 (44) 561-51-00
                    </span>
                </li>
               <!-- <li class="center">
                    <img src="{{URL::asset('static/img/Life.svg')}}"  height="20" alt="Life:)">
        ...
        <div class="perc-25">
            ...
            <div class = "container container-full-width container_content-space-between">
                <a href="https://vk.com" target="_blank">
                   <!-- <object type="image/svg+xml" data="{{URL::asset('static/img/facebook.svg')}}" class="logo" width="40">
                        Kiwi Logo <!-- fallback image in CSS
                    </object> -->
                       <img src="{{URL::asset('static/img/facebook.svg')}}" alt="vk.com" width="40">
                </a>
                <a href="#" target="_blank">
                <object type="image/svg+xml" data="{{URL::asset('static/img/instagram.svg')}}" class="logo" width="40">
                    Kiwi Logo <!-- fallback image in CSS -->
                </object>
                </a>
                    <a href="#" target="_blank">
                <object type="image/svg+xml" data="{{URL::asset('static/img/vk.svg')}}" class="logo" width="40">
                    Kiwi Logo <!-- fallback image in CSS -->
                </object>
                    </a>
                        <a href="#" target="_blank">
                            <object type="image/svg+xml" data="{{URL::asset('static/img/ok.svg')}}" class="logo" width="40">
                                Kiwi Logo <!-- fallback image in CSS -->
                            </object>
                        </a>
...
<script src="{{URL::asset('static/js/interface.js')}}" ></script>

<script src="{{URL::asset('/static/js/vue/cart.js')}}"></script>

<script src="{{URL::asset('/static/js/ajax_action.js')}}"></script>
<script src="{{URL::asset('/static/js/myslider.js')}}"></script>
